...
class TransactionTrackerGui:
    def __init__(self, master):
        ...
        master.title("Transaction Tracker - Margin")

        self.lbl_blank_header = Label(master, text=(" "*100), font=("Arial", 36), bg=self.black)
        self.lbl_blank_header.place(x=0,y=0)

        #Generator
        self.lbl_generator = Label(master, text="Margin TRACKER", font=("Fixedsys", 18, "bold"), bg=self.black, fg=self.light_green)
        ...
        #Label Intended Sell
        self.lbl_intended_sell = Label(master, text="Sell Margin", fg=self.title_text, bg=self.bg, font=("Arial", 9))
        ...
        #Label Buy Price
        self.lbl_buy_price = Label(master, text="Buy Margin", fg=self.title_text, bg=self.bg, font=("Arial", 9))
    ...
    def submit(self):
        path = constants.PATH_TO_DATABASE #TODO: add path to other database in constants
